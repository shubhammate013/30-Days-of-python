...
def generate_full_name (first_name, last_name):
    ...
    full_name = first_name + space + last_name
    return full_name
print('Full Name: ', generate_full_name('Shubham','Mate'))
...
def function_name(para1, para2):
    ...
    codes
# Calling function
print(function_name(para1 = 'Itachi', para2 = 'Uchicha')) # the order of arguments does not matter here
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print(print_fullname(firstname = 'Shubham', lastname = 'Mate'))
...
def print_name(firstname):
    return firstname
print_name('Shubham') # Shubham

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='Shubham', lastname='Mate')
...
def generate_full_name (first_name = 'Shubham', last_name = 'Mate'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i)
print(generate_groups('Team-1','Shubham','Aditya','Harshal','Manas'))
