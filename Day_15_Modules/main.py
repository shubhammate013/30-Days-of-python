...
# main.py file
import mymodule
print(mymodule.generate_full_name('Shubham', 'Mate')) # Shubham Mate
...
print(generate_full_name('Shubham','Mate'))
...
# python script.py Shubham 30DaysOfPython
